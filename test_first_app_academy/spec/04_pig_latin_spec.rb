...
describe "#translate" do
  ...
  it "capitalized words are still capitalized but with different first letter" do
	(translate ("The Man Who Loves to Write")).should == "Ethay Anmay Owhay Oveslay otay Itewray"
	end
end
